...
| Hall Effect Sensor | Able to track information about the motor | Send information about the motor (IE: Speed, Posiotion, Displacement) to the microcontroller | Yes |
